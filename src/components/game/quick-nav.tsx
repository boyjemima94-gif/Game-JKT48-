      ...
      <AnimatePresence>
        {visible && (
          <motion.button
            ...
            className="fixed top-3 left-3 z-[80] w-11 h-11 rounded-full bg-noir-coal/90 border border-noir-brass/40 backdrop-blur flex items-center justify-center shadow-[0_4px_16px_rgba(0,0,0,0.8)] hover:border-noir-brass transition-colors"
          >
            <motion.span
      ...
      <AnimatePresence>
        {open && visible && (
          <motion.div
            ...
            className="fixed top-16 left-3 z-[81] w-56 max-h-[80vh] overflow-y-auto bg-noir-coal/95 backdrop-blur border border-noir-brass/40 rounded-sm shadow-[0_8px_30px_rgba(0,0,0,0.9)]"
          >
            {/* header */}
